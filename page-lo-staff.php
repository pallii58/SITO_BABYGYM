...
<main id="primary" class="site-main site-main--wide">
    <article class="filosofia-page">
        <section class="filosofia-hero card card--centered">
            ...
            <p class="filosofia-lead"><?php echo esc_html__('I fondatori', 'babygym'); ?></p>
        </section>
        ...
        <section class="filosofia-section card card--centered">
            ...
            <p><?php echo esc_html__('Tutti gli istruttori Baby Gym sono qualificati grazie a corsi e tirocini fatti presso la nostra sede.', 'babygym'); ?></p>
            <p><?php echo esc_html__('Ognuno di loro ha un personale curriculum formativo e, nella maggior parte dei casi, diploma o laurea in scienze motorie.', 'babygym'); ?></p>
        </section>
    </article>
</main>
<?php
